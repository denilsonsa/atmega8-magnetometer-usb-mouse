...
através do \textit{report descriptor}. \cite{usbhid}
...
porta do microcontrolador. \cite[usbconfig-prototype.h]{VUSBdriver}
Portanto, a linha D+ foi ligada ao pino 4 (PD2/INT0), e a linha D- foi
ligada ao pino 2 (PD0).
...
Para um produto a ser comercializado, o fabricante precisa adquirir um
\textit{vendor-id} juntamente com o \ac{USB-IF}, e pode escolher o
...
funcione corretamente. Por fim, foi necessário implementar a função
\texttt{usbFunctionSetup()}.
...
O sistema de menus é iniciado apertando o botão o botão ``confirma''.
Enquanto dentro dos menus, o item atualmente selecionado é digitado na tela.
Todas as principais funcionalidades do \textit{firmware} podem ser acessadas
através dos menus.
