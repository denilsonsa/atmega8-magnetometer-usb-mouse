...
\textit{vendor-id} juntamente com a \ac{USB-IF}, e pode escolher o
...
é viável.\footnote{
	O logotipo USB, é uma marca registrada da \ac{USB-IF}, e só pode ser
...
Development Software GmbH.}.\footnote{
	...
	\cite[USB-IDs-for-free.txt]{VUSBdriver} Após uma troca de e-mails com a 
	\textit{Objective Development Software GmbH.}, e sabendo que o uso era
	para fins acadêmicos, foi sugerido usar valores quaisquer, aleatórios
	para esses campos.
}
