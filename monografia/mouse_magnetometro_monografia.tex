...
%\title{Dispositivo apontador USB usando magnetômetro}
...
\titulo{Dispositivo apontador USB usando magnetômetro}
...
\begin{resumo}
Este projeto tem como objetivo implementar um dispositivo USB de interface
humano-computador do tipo \textit{absolute pointing device}, utilizando um
microcontrolador AVR ATmega8 de 8 bits e um magnetômetro.
\end{resumo}
