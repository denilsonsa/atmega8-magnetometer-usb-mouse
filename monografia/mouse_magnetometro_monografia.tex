...
\label{ape:makefile}
\lstinputlisting[language=make, lineskip=-0.4\baselineskip]{../firmware/Makefile}
...
\lstinputlisting[language=Python, lineskip=-0.4\baselineskip]{../projection/generate_sphere_vectors.py}
...
\lstinputlisting[language=Python, lineskip=-0.4\baselineskip]{../projection/draw_points.py}

\chapter{\texttt{render\_images.sh}}
\label{ape:render_images}
\lstinputlisting[language=bash, lineskip=-0.4\baselineskip]{../projection/render_images.sh}
