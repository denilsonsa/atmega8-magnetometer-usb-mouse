...
Acredite, haverá agradecimenos aqui nesta página.


\begin{resumo}
Este projeto tem como objetivo implementar um dispositivo apontador
compatível com um mouse USB, utilizando um microcontrolador AVR ATmega8 de 8
...
ponteiro do mouse na tela do computador seguindo os movimentos de um sensor.
...
%
%Essencialmente, o \textit{firmware} deste projeto gerencia a comunicação
%\ac{USB} com o computador e a comunicação \ac{I2C} com o sensor. TODO!
...
introduzidas por cada abordagem.
