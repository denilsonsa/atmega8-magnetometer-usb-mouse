...
ATmega8 é um microcontrolador de 8 bits da família AVR. Suas características
são:

\begin{itemize}
\item Arquitetura Harvard, com espaços de endereçamento distintos para as
instruções e para as variáveis.
