\documentclass[brazil,pagestart=firstchapter,draft]{abnt}
...
pino DRDY for monitorado. \cite{HMC5883L} Este pino normalmente fica
no nível lógico 1, porém cai para 0 por \SI{250}{\micro\second} assim que
uma nova medida é colocada nos registradores de dados. \cite{HMC5883L}
